...
#let document-annotation(id) = if id == "tz" [
  ...
  Данный программный документ представляет собой пояснительную записку к программному проекту "#project-name()" содержит следующие разделы: "Введение", "Назначение и область применения", "Технические характеристики", "Ожидаемые технико-экономические показатели", приложения.
  ...
  Настоящая Программа и методика испытаний для "#project-name()" содержит следующие разделы: «Объект испытаний», «Цель испытаний», «Требования к программе», «Требования к программной документации», «Средства и порядок испытаний», «Методы испытаний», «Приложения».
